...
/obj/machinery/computer/rdconsole
	...
	req_access = list(access_research,access_adminlvl1)	//Data and setting manipulation requires scientist access.
...
/obj/machinery/computer/rdconsole/OnTopic(user, href_list)
	if(href_list["menu"]) //Switches menu screens. Converts a sent text string into a number. Saves a LOT of code.
		...
		spawn(20)
			...
			PR.info += "<i>report prepared at [station_time_timestamp("hh:mm")] local time</i></center><br>"
